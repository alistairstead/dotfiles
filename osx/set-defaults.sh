...
# sudo scutil --set ComputerName "Hunidor"
# sudo scutil --set HostName "Hunidor"
# sudo scutil --set LocalHostName "Hunidor"
...
defaults write com.apple.notificationcenterui bannerTime 0.75
...
# enable all sounds, incl volume change feedback
defaults write "com.apple.sound.beep.feedback" -int 1
defaults write com.apple.systemsound 'com.apple.sound.beep.volume' -float 1
...
# Turn off keyboard illumination when computer is not used for x
...
open "${HOME}/src/dotfiles/init/astead.terminal"
sleep 1 # Wait a bit to make sure the theme is loaded
defaults write com.apple.terminal "Default Window Settings" -string "astead"
defaults write com.apple.terminal "Startup Window Settings" -string "astead"
...
# Install my theme theme for iTerm
open "${HOME}/src/dotfiles/init/astead.itermcolors"
...
# Disable Gatekeeper so that brew works
